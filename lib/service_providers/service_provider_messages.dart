...
class ServiceProviderMessages extends StatefulWidget {
  const ServiceProviderMessages({Key? key}) : super(key: key);

  @override
  State<ServiceProviderMessages> createState() => _ServiceProviderMessagesState();
}

class _ServiceProviderMessagesState extends State<ServiceProviderMessages> {
                                  ...
                                  children: <Widget>[
                                    ...
                                    RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: "${providerData['firstName']} ${providerData['lastName']}",
