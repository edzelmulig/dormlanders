...
import 'package:dormlanders/client/my_appointments/appointment_card.dart';
...
class ClientMyAppointments extends StatefulWidget {
  const ClientMyAppointments({super.key});

  @override
  State<ClientMyAppointments> createState() => _ClientMyAppointmentsState();
}

class _ClientMyAppointmentsState extends State<ClientMyAppointments> {
