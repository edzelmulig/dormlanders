              ...
              children: <Widget>[
                ...
                StreamBuilder<Map<String, dynamic>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    lastName = userData['lastName'] ?? 'No Name';
                    displayName =
                  ...
                  onPressed: () {
                    navigateWithSlideFromRight(
                      ...
                      const UserAccountInformation(
                        text:
                            "Your personal information is safeguarded with the "
                            "utmost confidentiality and will not be disclosed "
                  ...
                  onPressed: () {
                    navigateWithSlideFromRight(
                      ...
                      const UserPhoneNumber(
                        text: "Your phone number is safeguarded with the "
                            "utmost confidentiality and will not be disclosed "
                            "publicly under any circumstances.",
                      ),
                      1.0,
                  ...
                  onPressed: () {
                    navigateWithSlideFromRight(
                      ...
                      const UserEmailAddress(
                        text: "Your email address is safeguarded with the "
                            "utmost confidentiality and will not be disclosed "
                            "publicly under any circumstances.",
                      ),
                      1.0,
                ...
                const CustomTextDescription(
                  descriptionText:
                      "Your personal information is safeguarded with the utmost "
